...
1. Extraction completeness: What percentage of the ground truth issues were extracted?
...
def evaluate_with_gpt(gt_issues, ext_issues):
    ...
    try:
        ...
        print("GPT response text was:", text)
        return None
...
def main():
    ...
    print("LLM-based evaluation complete!")
